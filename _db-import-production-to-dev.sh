...
wp search-replace www.boilerplate.com kimnatura.test --url=www.boilerplate.com --all-tables

# Search and replace for https to http
wp search-replace https://kimnatura.test http://kimnatura.test --all-tables
