            ...
            <div class="search__header">
                ...
                <div class="search__form-wrapper">
                    <form class="search__form" role="search" method="get" onsubmit="event.preventDefault()" id="search-form">
                        <input id="search-input" class="search__input" value="<?php the_search_query(); ?>" name="s" type="search" placeholder="<?php echo __('Traži', 'kimnatura')?>" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" />
                        <span class="search__info"><?php echo __('Upišite pojam za pretraživanje', 'kimnatura')?></span>
                    </form>
                </div>
            </div>
...
<p><?php echo __('Pretraga u tijeku', 'kimnatura'); ?><br><?php echo __('Molimo pričekajte','kimnatura'); ?></p>
</div>
