...
if ( $terms_page_id > 0 && apply_filters( 'woocommerce_checkout_show_terms', true ) ) :
	...
	<p class="form-row terms wc-terms-and-conditions">
		<label class="woocommerce-form__label woocommerce-form__label-for-checkbox checkbox">
			...
			<span><?php echo __( 'Pristajem na <a href="/uvjeti-koristenja-internetske-stranice/" target="_blank" class="1woocommerce-terms-and-conditions-link">uvjete korištenja</a>', 'woocommerce' );?></span> <span class="required">*</span>
		</label>
