...
<?php endif; ?>
		...
		<form class="woocommerce-form1111 woocommerce-form-login login" method="post">
			...
			<p class="form-row login__btn-row" id="submit-btn">
				...
				<button type="submit" class="woocommerce-Button button  btn btn--primary btn--small" name="login" value="<?php esc_attr_e( 'Login', 'woocommerce' ); ?>"><?php esc_html_e( 'Login', 'woocommerce' ); ?></button>
