(function($){
    ...
    var navigation = $('.page__shop-checkout-navigation');
    var activestep = $('.page__shop-checkout-navigation-item.is-active');
    ...
    function init(){
        ...
        if (count>0){
            jQuery('input[name="payment_method"]').bind('change',function(){
                jQuery(this).parent().parent().find('.is-active').removeClass('is-active');
