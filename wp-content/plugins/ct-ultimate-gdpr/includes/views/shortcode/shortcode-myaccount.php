...
<div class="ct-ultimate-gdpr-container<?php echo esc_attr( $ct_form_skin_class ); ?>">
    ...
    <div id="tabs">
        ...
        <div id="tabs-1">
            ...
            <form id="ct-ultimate-gdpr-data-access" method="post">
                ...
                <?php if ( $ct_form_skin == '' || $ct_form_skin == 'ct-ultimate-gdpr-simple-form' ) : ?>
                ...
                if (
                    ...
                    || $ct_form_skin == 'ct-ultimate-gdpr-tabbed-form'
                ) :
                ?>
            ...
            <form id="ct-ultimate-gdpr-forget" method="post">
                ...
                <div class="ct-ultimate-gdpr-services-list">
				    ...
				    foreach ( $options['services'] as $service ):
					    ...
					    if ( ! $service->is_forgettable() ) continue;
                    ...
                    <div class="ct-ultimate-gdpr-services-email">
                        ...
                        <?php if ( $ct_form_skin == '' || $ct_form_skin == 'ct-ultimate-gdpr-simple-form' ) : ?>
                            <input type="email" name="ct-ultimate-gdpr-email" value="" required="" id="ct-ultimate-gdpr-forget-email">
                        <?php endif; ?>
                    </div>
            ...
            <form id="ct-ultimate-gdpr-unsubscribe" method="post">
                ...
                <div class="ct-ultimate-gdpr-services-list">
				    ...
				    foreach ( $options['services'] as $service ):
                        ...
                        if ( ! $service->is_subscribeable() ) continue;
                    ...
                    <div class="ct-ultimate-gdpr-services-email">
					    ...
					    <?php if ( $ct_form_skin == '' || $ct_form_skin == 'ct-ultimate-gdpr-simple-form' ) : ?>
                            <input type="email" name="ct-ultimate-gdpr-email" value="" required="" id="ct-ultimate-gdpr-unsubscribe-email">
					    <?php endif; ?>
                    </div>

                    <label for="ct-ultimate-gdpr-consent-unsubscribe">
                        <input type="checkbox" id="ct-ultimate-gdpr-consent-unsubscribe" name="ct-ultimate-gdpr-consent-unsubscribe" required="">
                        <span class="ct-checkbox"></span>
					    <?php echo esc_html__( "I consent to have my email collected in order to process this request. See Privacy Policy page for more information.", 'ct-ultimate-gdpr' ); ?>
                    </label>
				    <?php
                    ...
                    <input type="submit" class="ct-ultimate-gdpr-unsubscribe-submitBtn" name="ct-ultimate-gdpr-unsubscribe-submit"
                           value="<?php echo esc_html__( "Submit", 'ct-ultimate-gdpr' ); ?>">
