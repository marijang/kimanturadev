...
<div class="container detailed-features">
    ...
    <div class="row">
		...
		<?php endif; ?>
            ...
            <div class="feature"><a href="#" class="ct-full-link"></a>
		...
		<?php if ( $url = ct_ultimate_gdpr_get_value( 'policy_url', $options ) ) : ?>
            ...
            <div class="feature"><a href="<?php echo esc_url( $url ); ?>" class="ct-full-link"></a>
		...
		<?php if ( $url = ct_ultimate_gdpr_get_value( 'terms_url', $options ) ) : ?>
            ...
            <div class="feature"><a href="<?php echo esc_url( $url ); ?>"
                                       class="ct-full-link"></a>
