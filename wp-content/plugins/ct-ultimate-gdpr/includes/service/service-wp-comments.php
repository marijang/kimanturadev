...
class CT_Ultimate_GDPR_Service_WP_Comments extends CT_Ultimate_GDPR_Service_Abstract {
	...
	public function comment_form_submit_field_filter( $markup ) {
		...
		$inject = CT_Ultimate_GDPR::instance()->get_admin_controller()->get_option_value( 'services_wp_comments_consent_field', false, CT_Ultimate_GDPR_Controller_Services::ID );
		if( $inject ) {
