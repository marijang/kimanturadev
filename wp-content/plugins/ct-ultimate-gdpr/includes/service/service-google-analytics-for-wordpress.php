...
class CT_Ultimate_GDPR_Service_Google_Analytics_For_Wordpress extends CT_Ultimate_GDPR_Service_Abstract {
	...
	public function maybe_disable_tracking() {
		...
		if (
			CT_Ultimate_GDPR::instance()->get_admin_controller()->get_option_value( "cookie_services_google_analytics_for_worpdress_disabled", '', CT_Ultimate_GDPR_Controller_Cookie::ID ) &&
