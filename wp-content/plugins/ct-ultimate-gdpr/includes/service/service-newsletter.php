...
class CT_Ultimate_GDPR_Service_Newsletter extends CT_Ultimate_GDPR_Service_Abstract {
	...
	public function newsletter_form_elements_filter() {
		...
		$inject         = CT_Ultimate_GDPR::instance()->get_admin_controller()->get_option_value( 'services_newsletter_consent_field', false, CT_Ultimate_GDPR_Controller_Services::ID );
		$position_first = CT_Ultimate_GDPR::instance()->get_admin_controller()->get_option_value( 'services_newsletter_consent_field_position_first', false, CT_Ultimate_GDPR_Controller_Services::ID );
