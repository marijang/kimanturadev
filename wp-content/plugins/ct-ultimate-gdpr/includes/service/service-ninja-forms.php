...
class CT_Ultimate_GDPR_Service_Ninja_Forms extends CT_Ultimate_GDPR_Service_Abstract {
	...
	public function front_action() {
		$inject = CT_Ultimate_GDPR::instance()->get_admin_controller()->get_option_value( "services_ninja_forms_consent_field", false, CT_Ultimate_GDPR_Controller_Services::ID );
		if ( $inject ) {
