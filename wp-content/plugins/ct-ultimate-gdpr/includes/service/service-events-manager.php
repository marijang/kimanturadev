...
class CT_Ultimate_GDPR_Service_Events_Manager extends CT_Ultimate_GDPR_Service_Abstract {
	...
	public function booking_form_action( $event ) {
		...
		$inject = CT_Ultimate_GDPR::instance()->get_admin_controller()->get_option_value( 'services_events_manager_consent_field', false, CT_Ultimate_GDPR_Controller_Services::ID );
